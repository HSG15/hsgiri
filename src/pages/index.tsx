...
export default function Home() {
  return (
    <>
      <Head>
        <title>Harishankar Giri</title>
        <meta name="description" content="Portfolio of Harishankar Giri – Aspiring Data Engineer" />
        <link rel="icon" href="/images/hsg_favicon.png" />
      </Head>
